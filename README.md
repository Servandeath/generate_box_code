...
Пример: `MANI_16_07_2026_DEMI_BT_R4N001`

- `CABINET` — код кабинета из справочника (справочник редактируемый,
  не хардкод)
...
- `RANDOMSEQ` — без разделителя внутри: случайные буквенно-цифровые
  символы + порядковый номер (число цифр зависит от `max_seq`,
  см. ниже)
...
с юнит-тестами на граничные случаи. Дальше: транслитерация кириллицы,
схема БД, GUI-слои.
