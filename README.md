...
- **Именованные шаблоны настроек этикетки (пресеты)** - можно
  сохранить несколько конфигураций и переключаться между ними одной
  кнопкой
...
**v1.0** - реализован и рабочий: генерация, БД, справочники, GUI,
печать этикеток, история, перепечатка, экспорт. Покрыто юнит- и
